...
module.exports = {
    ...
    single: id => {
        return db.load(`select *, date_format(NgayDang,"%d-%m-%Y") as NgayDangBai from nhantag nt join tag_baibao tb on nt.idTag = tb.idTag  join  baibao b on tb.idBaiBao= b.idBaiBao  join chuyenmuc c on b.ChuyenMuc = c.idChuyenMuc where idBaiBao = ${id} and  b.Xoa!=1  `);
